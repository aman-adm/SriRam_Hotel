...
@push('title')
    <title>Create Room Type - Dashboard</title>
@endpush
            ...
            <form action="{{ url('add_room') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title') }}" required class="form-control" aria-describedby="titleHelp">
                        <small id="titleHelp" class="form-text text-muted">Enter a descriptive title for the room.</small>
                    </div>
                    <div class="col-md-6">
                        <label for="price" class="form-label fw-bold">Price</label>
                        <input type="number" name="price" id="price" value="{{ old('price') }}" required class="form-control" aria-describedby="priceHelp">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <small id="wifiHelp" class="form-text text-muted">Specify whether the room has free Wi-Fi.</small>
                    </div>
                </div>

                <div class="mb-3">
                    <label for="description" class="form-label fw-bold">Description</label>
                    <textarea name="description" id="description" required rows="4" class="form-control" style="width: 100%;">{{ old('description') }}</textarea>
                </div>

                <div class="mb-3">
                    <label for="image" class="form-label fw-bold">Upload Image</label>
                    <input type="file" name="image" id="image" required class="form-control" aria-describedby="imageHelp">
